...
export default class SorveteForm extends React.Component {

    constructor(props) {
        super(props);
        this.state = { sabor: 'uva', casquinha: true, guardanapos: 'sim' };
        ...
        return (
            <form onSubmit={this.handleSubmit} style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <label>
                    ...
                    <div className='radio'>
                        <label>
                            <input type="radio" id='guardanapos' name='guardanapos' checked={this.state.guardanapos === 'nao'} value='nao' onChange={this.handleInputChange} />
                            não
                        </label>
                    </div>
                </label>
