...
INSERT INTO `diotube`.`canais` (`id_canal`, `nome_canal`) VALUES
(1, 'React'),
(2, 'PHP'),
(3, 'CSS'),
(4, 'HTML');
...
INSERT INTO `diotube`.`videos` (`id_video`, `nome_video`, `autor_video`) VALUES
...
CREATE TABLE `diotube`.`videos_canais` (
...
INSERT INTO `diotube`.`videos_canais` (`id_canais_video`, `fk_canal`, `fk_video`) VALUES
(1, 2, 4),
(2, 2, 3),
(3, 1, 1),
(4, 1, 2),
...
--
ALTER TABLE `diotube`.`videos_canais`
  ADD CONSTRAINT `fk_canal` FOREIGN KEY (`fk_canal`) REFERENCES `diotube`.`canais` (`id_canal`),
  ADD CONSTRAINT `fk_video` FOREIGN KEY (`fk_video`) REFERENCES `diotube`.`videos` (`id_video`);
COMMIT;
