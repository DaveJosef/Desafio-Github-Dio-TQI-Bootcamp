...
public class ExercicioProposto01 {
    ...
    public static void main(String[] args) {
        ...
        LinkedHashSet<String> coresArcoIris3 = new LinkedHashSet<>(Arrays.asList("violeta", "anil", "azul", "verde", "amarelo", "laranja", "vermelho"));
        System.out.println(coresArcoIris3);
        ArrayList<String> coresArcoIrisList = new ArrayList<>(coresArcoIris3);
